                        ...
                        <div class="card-body">
                            @if (!empty($topVariables) && count($topVariables) > 0)
                                ...
                                <p class="text-muted mt-2" style="font-size: 0.9rem;">
                                    <strong>Keterangan:</strong> Grafik ini menunjukkan faktor-faktor yang paling sering ditemukan pada orang yang terkena stroke. 
                                    Misalnya, jika "Hipertensi" bernilai 70%, artinya 70% orang yang terkena stroke memiliki tekanan darah tinggi. 
                                    Begitu juga, "Usia di atas 60" berarti persentase orang dengan stroke yang berusia lebih dari 60 tahun.
                                </p>
                            @else
                                <p>Tidak ada data untuk ditampilkan.</p>
                            @endif
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (topVariablesCanvas && Object.keys(topVariables).length > 0) {
                    new Chart(topVariablesCanvas.getContext('2d'), {
                        type: 'bar',
                        data: {
                            labels: Object.keys(topVariables).map(label => {
                                if (label === 'age_above_60') return 'Usia di atas 60';
                                if (label === 'glucose_above_140') return 'Glukosa di atas 140';
                                if (label === 'bmi_above_30') return 'BMI di atas 30';
                                if (label === 'hypertension') return 'Hipertensi';
                                if (label === 'heart_disease') return 'Penyakit Jantung';
                                return label;
                            }),
                            datasets: [{
                                label: 'Persentase (%)',
