...
class AdminKonsultasi extends Controller
{
    ...
    {
        Log::info('AdminKonsultasi session check:', [Session::all()]);
        ...
        if ($request->ajax()) {
            $html = view('admin.konsultasi._table', compact('daftar_konsultasi'))->render();
