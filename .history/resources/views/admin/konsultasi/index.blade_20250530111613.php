                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="reply-form" action="{{ route('admin.konsultasi.reply') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text"
                                    class="form-control @error('nama_pemberi_jawaban') is-invalid @enderror" id="admin-name"
                                    name="nama_pemberi_jawaban" placeholder="Nama Anda" required>
...
@push('scripts')
    ...
    <script>
        ...
        function refreshData() {
            const url = '{{ route("admin.konsultasi.index") }}?' + new URLSearchParams(window.location.search);
            fetch(url, {
                method: 'GET',
                headers: {
