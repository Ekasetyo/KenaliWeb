            ...
            <div class="detail-container">
                    ...
                    <div class="col-md-6">
                        <div class="info-card">
                            ...
                            <p><i class="fas fa-user-circle label-icon"></i> <strong>Nama Konsultan:</strong> <span
                                    class="text-content">{{ Session::get('user')['name'] ?? 'Tidak diketahui' }}</span></p>
                    ...
                    <div class="col-md-6">
                        <div class="info-card">
                            ...
                            <p><i class="fas fa-comment label-icon"></i> <strong>Jawaban:</strong> <span
                                    class="text-content">{{ $konsultasi->jawaban ?? 'Sedang menunggu jawaban' }}</span></p>
                            ...
                            <p><i class="fas fa-check-circle label-icon"></i> <strong>Status:</strong>
                                <span class="badge {{ $konsultasi->jawaban ? 'badge-secondary' : 'badge-pending' }}">
                                    {{ $konsultasi->jawaban ? 'Selesai' : 'Manunggu' }}
                                </span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="text-right mt-4">
                    @if (!$konsultasi->jawaban)
                        <form action="{{ route('konsultasi.destroy', $konsultasi->_id) }}" method="POST"
