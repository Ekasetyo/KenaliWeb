    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow h-100 py-2">
                ...
                <div class="card-footer text-muted small text-center">
                    <p class="mb-0"><strong>Penjelasan:</strong> Grafik ini menampilkan persentase pasien laki-laki dan perempuan yang tercatat memiliki risiko stroke dalam data latih. Ini membantu melihat perbandingan risiko stroke antar jenis kelamin.</p>
                </div>
            </div>
        </div>
