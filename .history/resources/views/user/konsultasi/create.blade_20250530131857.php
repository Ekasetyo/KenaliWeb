...
@push('scripts')
    ...
    <script>
        function confirmSubmit() {
            // SweetAlert2 tidak mengembalikan nilai boolean secara langsung, jadi kita perlu mengembalikan false untuk mencegah submit default
            Swal.fire({
            ...
            return false; // Mencegah form submit otomatis sebelum SweetAlert selesai
        }
        ...
        @if (session('success'))
            Swal.fire({
                ...
                timer: 2000 // Tambahkan timer untuk notifikasi sukses
            });
        @endif
        @if (session('error'))
            Swal.fire({
                ...
                text: '{{ session('error') }}',
                showConfirmButton: false,
                timer: 2000 // Tambahkan timer untuk notifikasi error
            });
        @endif
    </script>
@endpush