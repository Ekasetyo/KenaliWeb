        ...
        try {
            ...
            $deteksisPerMonth = DB::connection('mongodb')
                ...
                ->aggregate([
                    ...
                    [
                        // Filter dokumen dengan created_at_date yang valid
                        '$match' => [
                            'created_at_date' => ['$ne' => null],
                        ],
                    ],
                    [
