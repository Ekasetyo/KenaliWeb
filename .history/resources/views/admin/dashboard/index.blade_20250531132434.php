            ...
            var artikelChart = new Chart(ctx2, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(23, 162, 184, 0.8)', // Sesuai dengan border-left-info
            ...
            var deteksiChart = new Chart(ctx3, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(75, 192, 192, 0.8)', // Sesuai dengan border-left-success
            ...
            var konsultasiChart = new Chart(ctx4, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(255, 159, 64, 0.8)', // Sesuai dengan border-left-warning
