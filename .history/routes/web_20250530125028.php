...
Route::middleware(['login.session'])->prefix('user')->group(function () {
    ...
    Route::get('/konsultasi/create', [UserKonsultasi::class, 'edit'])->name('konsultasi.create');
    Route::put('/konsultasi/{id}', [UserKonsultasi::class, 'update'])->name('konsultasi.update');
