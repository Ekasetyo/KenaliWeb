                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="info-card">
                            ...
                            <p><i class="fas fa-user-circle label-icon"></i> <strong>Nama Pelanggan:</strong> <span class="text-content">{{ $konsultasi->pengguna->name ?? 'Tidak diketahui' }}</span></p>
                            <p><i class="fas fa-user-nurse label-icon"></i> <strong>Admin:</strong> <span class="text-content">{{ Auth::user()->name ?? 'Tidak diketahui' }}</span></p>
