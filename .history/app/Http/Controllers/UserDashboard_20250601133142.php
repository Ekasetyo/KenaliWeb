...
class UserDashboard extends Controller
{
    ...
    private function getDeteksiData($userId)
    {
        ...
        try {
                ...
                [
                    '$addFields' => [
                        'month' => ['$month' => ['$dateFromString' => [
                            'dateString' => ['$toString' => '$created_at'], // Adjusted for compatibility
            ...
            // Use selectCollection instead of collection
        ...
        try {
            ...
            if ($totalStroke > 0) {
                $factorDefinitions = [
                    ...
                    'avg_glucose_level' => ['avg_glucose_level' => ['$gt' => 180]],
                    'bmi' => ['bmi' => ['$gt' => 25]],
                    'ever_married' => ['ever_married' => 1],
