            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="guide-card">
                        ...
                        <p><strong>Identitas:</strong> Tulis identitas Anda dengan format seperti "Halo, nama saya [Nama Anda], saya berusia [Umur] tahun, jenis kelamin [L/P], saya ingin berkonsultasi untuk diri saya sendiri/orang lain". Contoh: "Halo, nama saya Budi, saya berusia 25 tahun, jenis kelamin Laki-laki, Saya ingin berkonsultasi untuk diri saya sendiri/orang tua saya."</p>
                        <p><strong>Keluhan:</strong> Jelaskan keluhan Anda secara rinci, beserta hasil deteksi yang sudah di lakukan di aplikasi mobile Contoh: "Saya sudah melakukan deteksi dini untuk saya sendiri/orang tua/orang lain pada aplikasi kenali selama 1 bulan dengan hasil deteksi beresiko terkena stroke. Dalam 2 minggu pertama saya mengalmi gejala seperti kepala terasa berat dan sering terasa lelah. Namun 2 minggu terakhir gejala itu mulai hilang namun kadang-kadang kembali lagi. Apa yang harus saya lakukan? apakah gejala tersebut hal yang wajar untuk "</p>
                    </div>
