...
@section('content')
    <style>
        ...
        .info-card {
            ...
            border-left: 4px solid #2e7d32; /* Hijau lembut untuk aksen */
            padding: 15px;
            margin-bottom: 20px;
            border-radius: 5px;
        }
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="info-card">
                            ...
                            <p><i class="fas fa-user-circle label-icon"></i> <strong>Nama Pelanggan:</strong> {{ $konsultasi->pengguna->name ?? 'Tidak diketahui' }}</p>
                            <p><i class="fas fa-envelope label-icon"></i> <strong>Email:</strong> {{ $konsultasi->pengguna->email ?? '-' }}</p>
                            <p><i class="fas fa-id-card label-icon"></i> <strong>Identitas:</strong> {{ $konsultasi->identitas ?? '-' }}</p>
                            <p><i class="fas fa-exclamation-circle label-icon"></i> <strong>Keluhan:</strong> {{ $konsultasi->keluhan ?? '-' }}</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-card">
                            <h6><i class="fas fa-info-circle"></i> Informasi Konsultasi</h6>
                            <p><i class="fas fa-comment label-icon"></i> <strong>Jawaban:</strong> {{ $konsultasi->jawaban ?? 'Belum ada jawaban' }}</p>
                            <p><i class="fas fa-user-md label-icon"></i> <strong>Nama Pemberi Jawaban:</strong> {{ $konsultasi->nama_pemberi_jawaban ?? '-' }}</p>
                            <p><i class="fas fa-calendar-alt label-icon"></i> <strong>Dibuat Pada:</strong> {{ $konsultasi->created_at->format('d M Y H:i') }}</p>
