            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            @if (!empty($topVariables) && count($topVariables) > 0)
                                ...
                                <p class="text-muted mt-2" style="font-size: 0.9rem;">
                                    ...
                                    Misalnya, jika "Hipertensi" bernilai 70%, artinya 70% orang dengan stroke memiliki tekanan darah tinggi. 
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow h-100 py-2">
                        ...
                        <div class="card-body">
                            @if (isset($averageAgeRisk) && $averageAgeRisk > 0)
                                <div class="chart-container">
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const averageAgeRisk = {{ $averageAgeRisk ?? 0 }};
                ...
                console.log('Average Age Risk:', averageAgeRisk);
                        ...
                        options: {
                            ...
                            scales: {
                                y: { 
                                    ...
                                    suggestedMax: Math.max(genderRisk['Laki-laki'], genderRisk.Perempuan) * 1.2
                                },
                ...
                if (ageRiskCanvas && averageAgeRisk > 0) {
                        ...
                        options: {
                            ...
                            scales: {
                                y: { 
                                    ...
                                    suggestedMax: averageAgeRisk * 1.2
                                },
                                x: { grid: { display: false } }
                            },
                            plugins: {
