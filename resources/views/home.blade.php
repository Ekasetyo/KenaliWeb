                    ...
                    <div class="row g-5"> 
                        ...
                        <div class="col-lg-4 d-flex justify-content-center justify-content-lg-end wow fadeInUp" data-wow-delay="0.3s">
                            <div class="owl-carousel screenshot-carousel">
                                <img class="img-fluid" src="{{ asset('assets/img/finomali_depan.png') }}" alt="">
                                <img class="img-fluid" src="{{ asset('assets/img/finomali_depan2.png') }}" alt="">
                                <img class="img-fluid" src="{{ asset('assets/img/finomali_login.png') }}" alt="">
                                <img class="img-fluid" src="{{ asset('assets/img/finomali_register.png') }}" alt="">
                                <img class="img-fluid" src="{{ asset('assets/img/finomali_dashboard.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
