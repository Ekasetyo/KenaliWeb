            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="guide-card">
                        ...
                        <p><strong>Identitas:</strong> Tulis identitas Anda dengan format seperti "Halo, nama saya [Nama Anda], saya berusia [Umur] tahun, jenis kelamin [L/P], saya ingin berkonsultasi untuk diri saya sendiri/orang lain. Contoh: "Halo, nama saya Budi, saya berusia 25 tahun, jenis kelamin Laki-laki, Saya ingin berkonsultasi ."</p>
