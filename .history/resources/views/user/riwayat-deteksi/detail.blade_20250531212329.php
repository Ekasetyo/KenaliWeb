...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Detail Hasil Deteksi</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary text-white">
            <h6 class="m-0 font-weight-bold">Informasi Deteksi Risiko Stroke</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="card h-100 border-left-primary shadow">
                        <div class="card-body">
                            ...
                            <div class="mb-2"><strong>Nama Akun:</strong> {{ $data->name ?? '-' }}</div>
            ...
            <div class="text-center">
                <a href="{{ route('user.riwayat-deteksi') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
    </div>
</div>
