...
@section('content')
    <div id="content">
                    ...
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Hasil Deteksi
                                    </div>
        ...
        <!-- Chart untuk Usia yang Berisiko Stroke -->
                <div class="col-lg-6 mb-4">
                    <div class="card shadow h-100 py-2">
                        <div class="card-header">
                            <h6 class="m-0 font-weight-bold text-info">Risiko Stroke Berdasarkan Usia</h6>
                        </div>
                        <div class="card-body">
                ...
                <!-- Chart untuk Jumlah Pasien Berdasarkan Jenis Kelamin -->
                <div class="col-lg-6 mb-4">
                    <div class="card shadow h-100 py-2">
                        <div class="card-header">
                            <h6 class="m-0 font-weight-bold text-info">Jumlah Pasien Berdasarkan Jenis Kelamin</h6>
                        </div>
                        <div class="card-body">
    ...
    @push('scripts')
        ...
        <script>
            ...
            if (konsultasiCanvas) {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                callbacks: {
                                    label: function(tooltipItem) {
                                        return 'Konsultasi: ' + Math.floor(tooltipItem.raw);
                                    }
                                }
                            }
                        }
             ...
             // Chart untuk Risiko Stroke Berdasarkan Usia
            ...
            if (genderCanvas) {
                new Chart(genderCanvas.getContext('2d'), {
                    ...
                    options: {
                        ...
                        scales: {
                            y: { beginAtZero: true },
                            x: { title: { display: true, text: 'Jenis Kelamin' } }
                        },
                        plugins: { legend: { display: false } }
                    }
                });
