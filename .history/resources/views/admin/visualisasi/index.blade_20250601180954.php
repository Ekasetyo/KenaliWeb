    ...
    @push('scripts')
        ...
        <style>
            ...
            .correlation-legend {
                ...
                height: 200px;
                /* Sesuaikan tinggi legenda agar sesuai dengan tabel */
                margin-left: 15px;
                font-size: 0.85rem;
                justify-content: space-between;
                /* Untuk menempatkan label di ujung */
            }
            ...
            .legend-labels {
                ...
                justify-content: space-between;
                height: 100%;
                /* Memastikan label mengisi tinggi yang sama dengan skala */
            }
        </style>
        <script>
                ...
                new Chart(bmiStrokeComparisonCanvas.getContext('2d'), {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            'rgba(255, 69, 0, 0.8)'], // CornflowerBlue vs Red Orange
                    ...
                    numericColumns.forEach(colCol => {
                        ...
                        if (correlation !== null) {
                            ...
                            const g = parseInt(bgColor.substring(bgColor.indexOf(',') + 1, bgColor.lastIndexOf(
                                ',')));
                            const b = parseInt(bgColor.substring(bgColor.lastIndexOf(',') + 1, bgColor.length -
                                1));
                        ...
                        heatmapHTML +=
                            `<td style="background-color: ${bgColor};" class="${textColor}">${correlation}</td>`;
                    });
                    heatmapHTML += '</tr>';
                });
