                ...
                new Chart(genderProportionCanvas.getContext('2d'), {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            'rgba(54, 162, 235, 0.8)'], // Warna berbeda
                ...
                numericColumns.forEach(rowCol => {
                    ...
                    numericColumns.forEach(colCol => {
                        ...
                        if (correlation !== null) {
                            ...
                            textColor = (brightness > 180) ? 'text-dark' :
                            'text-white'; // Jika terang, pakai teks gelap; jika gelap, pakai teks terang
                        } else {
