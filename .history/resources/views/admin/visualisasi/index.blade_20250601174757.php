    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow h-100 py-2">
                ...
                <div class="card-footer text-muted small text-center">
                    <p class="mb-0"><strong>Dasar:</strong> Diagram lingkaran (pie chart) efektif untuk menunjukkan proporsi bagian dari keseluruhan.</p>
                    <p class="mb-0"><strong>Penjelasan:</strong> Grafik ini menampilkan persentase pasien laki-laki dan perempuan yang tercatat mengalami stroke dalam data latih. Ini membantu melihat perbandingan risiko stroke antar jenis kelamin.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow h-100 py-2">
                ...
                <div class="card-footer text-muted small text-center">
                    ...
                    <p class="mb-0"><strong>Penjelasan:</strong> Grafik ini membandingkan rata-rata Indeks Massa Tubuh (BMI) antara pasien yang mengalami stroke dan yang tidak. Ini dapat memberikan wawasan tentang hubungan antara BMI dan risiko stroke.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow h-100 py-2">
                ...
                <div class="card-footer text-muted small text-center">
                    <p class="mb-0"><strong>Dasar:</strong> Grafik garis (line chart) atau batang (bar chart) dapat digunakan untuk menunjukkan tren atau perbandingan nilai rata-rata antar kategori.</p>
                    <p class="mb-0"><strong>Penjelasan:</strong> Grafik ini menampilkan rata-rata Indeks Massa Tubuh (BMI) untuk setiap tipe pekerjaan yang ada dalam data latih. Ini dapat membantu mengidentifikasi apakah ada perbedaan BMI yang signifikan antar kelompok pekerjaan.</p>
                </div>
            </div>
        </div>
