...
class UserKonsultasi extends Controller
{
    public function index()
    {
        ...
        Log::info('Daftar konsultasi untuk user:', ['id_pengguna' => (string)$id_pengguna, 'jumlah' => $daftar_konsultasi->count()]);
    ...
    public function create()
    {
        ...
        if ($user['status'] !== 'user') {
            return redirect()->back()->with('error', 'Hanya user biasa yang dapat membuat konsultasi.');
        }
    ...
    public function store(Request $request)
    {
        ...
        Log::info('Konsultasi baru dibuat:', ['id_konsultasi' => (string)$konsultasi->_id, 'id_pengguna' => (string)$id_pengguna]);
