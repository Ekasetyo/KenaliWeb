                    ...
                    options: {
                        ...
                        scales: {
                            y: {
                                ...
                                ticks: {
                                    stepSize: 1, // Menentukan langkah yang bulat
                                    callback: function(value) {
                                        return Number.isInteger(value) ? value : ''; // Hanya tampilkan angka bulat
                                    }
                                }
                            },
                            x: {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                callbacks: {
                                    label: function(tooltipItem) {
                                        return 'Konsultasi: ' + Math.floor(tooltipItem
                                        .raw); // Pembulatan untuk tooltip
                                    }
                                }
                            }
                        }
